...
const personalGrowthNavItems = [
  {
    ...
    href: "/personal-growth/upload-portfolio",
  },
  {
    ...
    role: "Personal Growth",
    href: "/personal-growth/skill-competency",
  },
  {
    icon: "pi pi-calendar",
    title: "Study Plan",
    ...
    role: "Personal Growth",
    href: "/personal-growth/study-plan",
  },
];
...
function Navigation({ isCollapsed }: { isCollapsed: boolean }) {
  return (
    ...
    >
      <div className="flex flex-row items-center gap-2 pt-4">
        ...
        {!isCollapsed && (
          <div className="flex flex-col flex-1 min-w-0">
            ...
            <p className="text-sm text-gray-500">Personal Growth</p>
          </div>
        )}
      ...
      >
        {personalGrowthNavItems.map((item) => (
          <NavigationItem
            key={item.title}
            item={item}
      ...
      <div className="border-b border-gray-200 mt-4 mb-2"></div>
      <a href="/personal-growth/profile">
        <div
          className={clsx(
...
export default function PersonalGrowthLayout({
  children,
}: Readonly<{
